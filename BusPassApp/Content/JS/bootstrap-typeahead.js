...
!function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        that.ReferenceField = that.options.ReferenceField || that.ReferenceField;
        ...
        render: function (items) {
            ...
            items = $(items).map(function (i, item) {
                if (typeof item === 'object') {
                    ...
                    display = item;
                    i = $(that.options.item).attr('data-value', item.split('~')[0]); //Updated by saranraj on 20170505 *** old:  i = $(that.options.item).attr('data-value', item);
                }
                ...
                if (data[0].hasOwnProperty(that.options.displayField)) {
                    ...
                    items = $.grep(data, function (item) {
                        ...
                        if (that.query.length > 3) {
                            checkflg = item;//Added by udhaya-purpose Get Specific typeing contentlengthcheck;//
                            return that.matcher(checkflg);
                        }
                        else {
                            if (item.split('~')[0].length == 9 && item.split('~')[0].toLowerCase().indexOf(that.query.toLowerCase()) != -1) {
                                checkflg = item;
                            }
                        else {
                                if (item.indexOf("(") != -1 && item.indexOf(")") != -1) {
                                    checkflg = item.split("(")[1];//Added by udhaya-purpose Get Specific typeing contentlengthcheck;//
                                    checkflg = checkflg.split(')')[0]; //Added by saranraj on 20170505...
                                }
                                else {
                                    checkflg = item;//Added by udhaya-purpose Get Specific typeing contentlengthcheck;//
                                }
