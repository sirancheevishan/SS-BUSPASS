    ...
    Typeahead.prototype = {
        ...
        lookup: function (event) {
            ...
            if (that.ajax) {
                ...
                that.query = (that.$element.val().indexOf("(") != -1 && that.$element.val().indexOf(")") != -1 ? "" : that.$element.val());

              //  if (!that.query) {
                if (that.query == null) { //Comment and added by saranraj... (#TBMT20170412)
                    return that.shown ? that.hide() : that;
                }
        ...
        highlighter: function (item) {
            ...
            if (item!=null) {
                ...
                else {//Added by saranraj... (#TBMT20170412)
                    return item;
                }
        ...
        render: function (items) {
            ...
            items = $(items).map(function (i, item) {
                ...
                //Added by saranraj on 20170123...
                    ...
                    var sb = '';
                    sb += '<div class="clstyphead one"><div class="float-left flighticon"><img src="/images/thyke/flight.png"></div><div class="float-left overall"><span class="clsflicode">' + replacebold[0].split('-')[1].split('(')[1].split(')')[0] + '</span><span class="clsthmail">' + replacebold[0].split('-')[0] + '</span>';
                    if (replacebold.length > 1) //This span for country images, for this need to add country_flag image and css file... by saranraj on 20170921 (#TBMT)
        ...
        grepper: function (data) {
            ...
            if (isString && data && data.length) {
                if (data[0].hasOwnProperty(that.options.displayField)) {
                    ...
                    else if (that.query.length == 0) { //Added by Saranraj for default citys on textbox focus... (#TBMT20170412)
        ...
        focus: function (e) {
            this.focused = true
            //Added by Saranraj for default citys on textbox focus... (#TBMT20170412)
            if (this.ajax)
                this.ajaxLookup()
            else
                this.lookup()
        ...
        click: function (e) {
            ...
            e.preventDefault()
            this.select()
            //this.$element.focus()  //Comment by saranraj ... (#TBMT20170412)
        },
